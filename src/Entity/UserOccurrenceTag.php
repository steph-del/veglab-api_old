 ...
 * @ORM\Table(name="user_occurrence_tag", indexes={@ORM\Index(name="user_id_occ_tag_idx", columns={"user_id"})}, options={"comment":"Les noms de tags utilisateurs doivent être uniques (pour un même utilisateur)."})
 */
